...
///////////////////////////////////////////////
// Textures
char *g_texture_file = "Data/road.raw";		// RGB
//char *g_texture_file = "Data/4922.raw";		// RGB
//char *g_texture_file = "Data/marble.raw";		// RGB
//char *g_texture_file = "Data/donut.raw";		// RGB
//char *g_texture_file = "Data/check.raw";		// RGB

static const int texture_w = 512;
static const int texture_h = 512;
static const int texture_c = 3;	// number of color, RGB


unsigned char *g_raw_texture;
...
{
	glUniform1i(glGetUniformLocation(g_shader_id, "flag_texture"), true);
...
void LoadTexture()
{
	...
	{
		// allocation
		int raw_data_size = texture_w * texture_h * texture_c;
		g_raw_texture = new unsigned char[ raw_data_size ];

		std::ifstream fin;

		fin.open(g_texture_file, std::ios::binary);
		fin.read((char*)(g_raw_texture), raw_data_size);
	...
	glBindTexture(GL_TEXTURE_2D, g_texture_id);
	glUniform1i(glGetUniformLocation(g_shader_id, "tex0"), 0);
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, 512, 512, 0, GL_RGB, GL_UNSIGNED_BYTE, g_raw_texture);
